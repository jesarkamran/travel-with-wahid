/* The booking rules, kept away from the form that renders them.
   ...
   Everything here is pure except the three functions that talk to the outside
   world: handoff, mirror and lookupPerson. */
 ...
 */
export async function mirror(form, trip, ref) {
